...
void scalar2(EXTENDED_POINT R, EXTENDED_POINT P, const unsigned long int k, const int window_size, const mpz_t N)
{
	EXTENDED_POINT tP;
	extended_point_init(tP);
	extended_point_set(tP, P);
...
void mscalar(MONTGOMERY_POINT R0, MONTGOMERY_POINT R1, const MONTGOMERY_POINT P, const unsigned long int k, mpz_t N)
{
  long int i, m;
